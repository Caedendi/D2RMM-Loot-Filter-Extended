...
export abstract class HighlightConstants {
  ...
  static defaultHighlightColor: D2Color = Settings.filter.settings.defaultHighlightColor;
  ...
  protected static patternXL = Settings.filter.runes.high.bigTooltip == EBigTooltipSetting.Disabled
    ? this.pattern3x10  // ********** ********** **********, or
    : this.pattern2x10; // ********** ********** (with big tooltips)

  public static highlightLevels = [
    { setting: "s",  pattern: this.pattern5,  padding: this.padding3 },
    { setting: "l",  pattern: this.pattern10, padding: this.padding5 },
    { setting: "xl", pattern: this.patternXL, padding: this.padding5 },
  ];
}
